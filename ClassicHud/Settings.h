...
public:
	...
	// Menu Title
	int MENUTITLE_R, MENUTITLE_G, MENUTITLE_B;
	...
	float MENUASK_X, MENUASK_Y, MENUASK_SIZE_X, MENUASK_SIZE_Y;
	...
	int MENU_RECT_R, MENU_RECT_G, MENU_RECT_B;
	float MENU_RECT_X, MENU_RECT_Y, MENU_RECT_WIDTH, MENU_RECT_HEIGHT;

	// Menu Stats / Settings
	int MENU_STATS_OUTLINE, MENU_STATS_SHADOW, MENU_SETTINGS_SHOW_RIGHT;
